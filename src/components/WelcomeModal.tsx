...
import { X, Info, LayoutGrid, Target, BarChart3 } from 'lucide-react';
...
interface WelcomeModalProps {
  ...
  customContent?: React.ReactNode; // Keeping support for the prop I used in PrecificacaoPage
}
...
export function WelcomeModal({ 
  ...
  const defaultDescription = "Entenda como a ferramenta ajuda a identificar o caminho de menor resistência para o lucro.";
